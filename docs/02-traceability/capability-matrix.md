...
| `CAP-CRM-004` | `/contacts` | `PARTIAL` | `LO`,`LV` | Phase 1 | PostgreSQL list/detail GETs and dormant atomic create persistence are `LOCAL-VERIFIED`; browser list/create authority is unchanged and production POST remains inactive |
