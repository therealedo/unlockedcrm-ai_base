...
| `GAP-PLAT-003` | `P0` | Durable records | `MISSING`; generated Prisma client and isolated adapter connectivity are `LOCAL-VERIFIED` | Phase 1 | Prisma migrations plus reviewed SQL constraints, PostgreSQL transactions, workspace repositories, reload and concurrency tests |
