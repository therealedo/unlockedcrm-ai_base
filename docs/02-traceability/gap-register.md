...
| `GAP-PLAT-007` | `P0` | Application API | `PARTIAL`, `LOCAL-VERIFIED` | Phase 1 | Fastify health plus the first stable CRM GET exist; add command and remaining domain routes behind repositories |
