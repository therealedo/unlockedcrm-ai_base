...
| `GAP-PLAT-003` | `P0` | Durable records | `PARTIAL`, `LOCAL-VERIFIED`: renewal migration, deterministic seed, constraints and scoped repository exist; no CRM route uses them | Phase 1 | GET/command transactions, reload and concurrency tests |
