...
| `CAP-PLAT-003` | PostgreSQL durable data/migrations | `MISSING` | Prisma generation and isolated adapter connectivity are `LOCAL-VERIFIED`; durable records remain `I` | Phase 1 development-grade persistence; Phase 2 hardening | Schema/migration/transaction/restore tests |
