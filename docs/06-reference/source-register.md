...
| `CONTACT-NORMALIZATION-2026-09-08` | Generic contact create normalization contract | `LOCAL-VERIFIED` | Strict-TDD pure proof for field normalization, bounds, ORIGINAL gender/tags, canonical payload bytes, and SHA-256; no repository, receipt transaction, registered POST, browser cutover, or create activation |
